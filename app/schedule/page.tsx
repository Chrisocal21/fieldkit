      ...
      <div className="mb-4 flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2 sm:px-3 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md"
          >
          ...
          <button
            ...
            className={`px-2 sm:px-4 py-2 text-sm font-medium border rounded-l-md ${
              viewMode === 'month'
          ...
          <button
            ...
            className={`px-2 sm:px-4 py-2 text-sm font-medium border-t border-b ${
              viewMode === 'week'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
          ...
          <button
            ...
            className={`px-2 sm:px-4 py-2 text-sm font-medium border rounded-r-md ${
              viewMode === 'day'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
