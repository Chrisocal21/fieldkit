            ...
            {WIDGET_ORDER.map(id => (
              ...
              >
                ...
                <button
                  ...
                  className={`relative inline-flex h-4 w-14 items-center rounded-full transition-colors flex-shrink-0 mt-0.5 focus:outline-none ${
                ...
                >
                  <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform ${
                    widgets[id] ? 'translate-x-9' : 'translate-x-px'
                  }`} />
                </button>
              </div>
            ))}
